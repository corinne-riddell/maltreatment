...
US <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/IPV-hurt-1/states/US/US-IPV-hurt-1.csv")

for(i in state_list[1:51]){
  counter <- 1
  assign(i, read_csv(paste0("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/IPV-hurt-1/states/", i, "/", i, "-IPV-hurt-1.csv")
  )
)
}
