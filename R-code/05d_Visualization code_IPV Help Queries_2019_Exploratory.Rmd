...
find.abuse.hotline <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-abuse-hotline.csv")

abuses.me <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-abuses-me.csv")

codeword <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-codewords.csv")

unsafe <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-feel-unsafe.csv")

hotline <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-find-hotline.csv")

shelter <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-find-shelter.csv")

partner.calm <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-how-to-calm.csv")

save.money <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-how-to-secretly-save.csv")

leave <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-leave-relationship.csv")

protect.kids <- read_csv("/Users/krisztafarkas/Box Sync/Google-search-data/2019ExploratoryData/IPV/AskingForHelpQueries/US-IPV-protect-kids.csv")
